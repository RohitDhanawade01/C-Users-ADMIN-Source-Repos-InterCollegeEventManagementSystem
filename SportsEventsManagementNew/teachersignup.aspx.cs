    ...
    public partial class teachersignup : System.Web.UI.Page
    {
        ...
        bool checkMemberExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from teacher_table where Teacher_ID ='" + TextBox8.Text.Trim() + "';", con);
        ...
        void signUpNewMember()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(" INSERT INTO teacher_table(firstname,lastname,gender,dob,contact,email,state,city,pincode,address,Teacher_ID,password,acstatus) values(@firstname,@lastname,@gender,@dob,@contact,@email,@state,@city,@pincode,@address,@Teacher_ID,@password,@acstatus)", con);
                ...
                cmd.Parameters.AddWithValue("@Teacher_ID", TextBox8.Text.Trim());
